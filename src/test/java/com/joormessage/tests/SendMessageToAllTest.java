...
public class SendMessageToAllTest extends BaseTest {

	@Test(testName = "TEST-001: Verify that the user will be able to send an email to All My Connections with out attachments")
	public void sendMessageToAllConnectins() {
		...
		EXEC.log("Composing the email to be sent to ALL connections");

		message.composeTheEmailToAllConnections();
